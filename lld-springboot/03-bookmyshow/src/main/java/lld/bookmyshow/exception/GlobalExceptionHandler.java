...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,Object>> handle(BookingException ex, HttpServletRequest req) {
        log.warn("[BMS] {} | path={}", ex.getMessage(), req.getRequestURI());
    ...
    public ResponseEntity<Map<String,Object>> handleValidation(MethodArgumentNotValidException ex, HttpServletRequest req) {
        ...
        return ResponseEntity.badRequest().body(Map.of("status", 400, "errors", errors, "path", req.getRequestURI()));
    }
}
